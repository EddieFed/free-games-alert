...
def confirm_number():
    ...
    # We will use this to iterate through every sequence set that was sent back from the search!
    # Now split the byte tuple since it's, well raw bytes, not an array of the sequence sets.
